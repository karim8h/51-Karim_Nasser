...
public class Rectangle extends MyShapes{
	...
	public void draw(Graphics canvas) {
		...
		try{
			...
			if(lineColor != null && canvas != null && position != null && properties != null)canvas.drawRect(getPosition().x - this.getProperties()
			...
			if(fillColor != null && canvas != null && position != null && properties != null)canvas.fillRect(getPosition().x - this.getProperties()
					.get(getPropertiesNames()[0]).intValue() / 2, getPosition().y - this.getProperties()
					.get(getPropertiesNames()[1]).intValue() / 2, this.getProperties()
					.get(getPropertiesNames()[0]).intValue(), this.getProperties()
					.get(getPropertiesNames()[1]).intValue());
